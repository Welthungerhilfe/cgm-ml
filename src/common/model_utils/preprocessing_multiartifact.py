...
def create_multiartifact_sample(artifacts: List[str], max_value, image_target_height, image_target_width, targets_indices) -> Tuple[tf.Tensor, tf.Tensor]:
...
def _preprocess_targets(targets, targets_indices):
