...
MODEL_CONFIG = Bunch(dict(
    ...
    RUN_ID='q3-depthmapmultiartifactlatefusion-plaincnn-height-95k_1618820318_1f00f331',  # Run 9
...
EVAL_CONFIG = Bunch(dict(
    # Name of evaluation
    NAME='q3-depthmapmultiartifactlatefusion-plaincnn-height-95k_run_09',
