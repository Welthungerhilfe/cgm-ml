...
MODEL_CONFIG = Bunch(dict(
    ...
    RUN_ID='q3-depthmapmultiartifactlatefusion-plaincnn-height-95k_1617033056_ee2f7a39',  # Run 7
...
EVAL_CONFIG = Bunch(dict(
    # Name of evaluation
    NAME='q3-depthmapmultiartifactlatefusion-plaincnn-height-95k_run_07',
