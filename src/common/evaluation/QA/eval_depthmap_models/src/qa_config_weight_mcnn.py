...
MODEL_CONFIG = Bunch(dict(
    ...
    RUN_ID='2021q2-depthmaplatefusion-plaincnn-weight-95k_1620032683_abfe54ed',  # Run 1
...
EVAL_CONFIG = Bunch(dict(
    # Name of evaluation
    NAME='2021q2-depthmaplatefusion-plaincnn-weight-95k_run_01',
...
DATA_CONFIG = Bunch(dict(
    ...
    TARGET_INDEXES=[1, ],  # 0 is height, 1 is weight, 2 is muac, 3 is age, 4 is sex('male' or 'female'), 5 is quality ('good' or 'bad'), 6 is test
